        ...
        <div>
            <div id="top-banner">
                <div class="container">
                    ...
                    <p><a href="index.html">Home</a> / <a href="privacy.html">Privacy</a></p>
                </div>
            </div>
                ...
                <div class="container">
                    ...
                    <div>
                        ...
                        <ul>
                            ...
                            <li>
                                <p><a href="https://matomo.org/privacy-policy/">Matomo</a></p>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <p>This Service does not use these &ldquo;cookies&rdquo; explicitly. However, the app may use third party
                            code and libraries that use &ldquo;cookies&rdquo; to collect information and improve their services. You have
                            the option to either accept or refuse these cookies and know when a cookie is being sent to your device. If you
                    ...
                    <div>
                        <p><strong>Facebook data deletion instructions for &ldquo;Programming Hero&rdquo;</strong></p>
                        <p>Follow the given instructions to delete your activity or information given on the Programming Hero App.&nbsp;</p>
                        <ol>
                            <li> Go to your Facebook Account&rsquo;s Setting &amp; Privacy. Click &ldquo;Settings&rdquo;</li>
                            <li> Look for &ldquo;Apps and Websites&rdquo; and you will see all of the apps and websites you linked with your Facebook.</li>
                            <li> Find &ldquo;Programming Hero&rdquo; and click on the Remove. The Programming Hero app will be removed.</li>
                            <li> Now scroll down to find the &ldquo;View Removed Apps and Websites&rdquo; option and click on it.</li>
                            <li> From the list try to find &ldquo;Programming Hero&rdquo; and then click &ldquo;View&rdquo;</li>
                            <li> Click the &ldquo;Send Request&rdquo; option.</li>
                            <li> Congratulations, you have successfully submitted your request for Data Deletion.</li>
                            <li> If you want to check your request status, just click on the &ldquo;View Status&rdquo; option.</li>
                            <li> We will review your request and delete your data within 5 working days.</li>
                            <li> If you face any issue with the process please mail us at <a href="mailto:support@programming-hero.com">support@programming-hero.com</a> with the confirmation number that was given to you after sending the request.</li>
                        </ol>
                    </div>
                    ...
                    <div>
                        ...
                        <p>If you have any questions or suggestions about our Privacy Policy, do not hesitate to contact us <a
                            href="mailto:codinism@gmail.com">codinism@gmail.com</a> .</p>
                        <p>&nbsp;</p>
                    </div>
                </div>
            </section>
